...
"""
通过国家统计局官网获取中国2016年所有城市数据
2016年统计用区划代码和城乡划分代码(截止2016年10月31日)
...
save_route = 'E://data/China_Province_2016.csv'  # 数据储存路径
results2 = []
results3 = []
results4 = []
results5 = []
...
for i2 in range(len(result1)):
    try:
        ...
        i2 += 1
        url2 = 'http://www.stats.gov.cn/tjsj/tjbz/tjyqhdmhcxhfdm/2016/' + url2a
    ...
    for i3 in range(len(result2a)):
        try:
            ...
            i3 += 1
            url3 = 'http://www.stats.gov.cn/tjsj/tjbz/tjyqhdmhcxhfdm/2016/' + url3a
            # http://www.stats.gov.cn/tjsj/tjbz/tjyqhdmhcxhfdm/2016/34/3401.html
        ...
        for i4 in range(len(result3a)):
            try:
                ...
                i4 += 1
                url4 = 'http://www.stats.gov.cn/tjsj/tjbz/tjyqhdmhcxhfdm/2016/' + url4a[3:5] + '/' + url4a
                # print(url4)
                # http://www.stats.gov.cn/tjsj/tjbz/tjyqhdmhcxhfdm/2016/41/04/410481.html
